export const liczba_pokoi_mazowieckie = {
    ...
    datasets: [
        ...
        {
            label: '2 pokoje',
            data: [{x: 2, y: 9926, r: 10}],
            backgroundColor: 'rgba(255, 206, 86, 0.5)',
            hoverBackgroundColor: 'rgb(255, 206, 86)',
        },
        {
            label: '3 pokoje',
            data: [{x: 3, y: 10571, r: 10}],
            backgroundColor: 'rgba(75, 192, 192, 0.5)',
            hoverBackgroundColor: 'rgb(75, 192, 192)',
        },
        {
            label: '4 pokoje',
            data: [{x: 4, y: 3638, r: 10}],
            backgroundColor: 'rgba(153, 102, 255, 0.5)',
            hoverBackgroundColor: 'rgb(153, 102, 255)',
        },
        {
            label: '5 pokoi',
            data: [{x: 5, y: 1384, r: 10}],
